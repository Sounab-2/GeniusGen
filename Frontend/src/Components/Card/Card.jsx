...
>
  ...
  >
    ...
    <p class="sm:text-lg md:text-lg text-sm text-white leading-relaxed ">
    ...
    <p class="md:text-lg text-sm text-white leading-relaxed mt-4 text-left md:w-1/2 sm:text-sm sm:w-72">
