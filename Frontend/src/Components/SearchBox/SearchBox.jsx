...
const SearchBox = () => {
    ...
    return (
        <div>
            <form onSubmit={handleSubmit} className="flex items-center max-w-lg mx-auto gap-2 md:gap-2">   
                ...
                <div className="relative w-full">
                    ...
                    <input 
                        type="text" 
                        id="voice-search" 
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-full w-40 ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
