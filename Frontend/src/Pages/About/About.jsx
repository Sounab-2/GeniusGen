          ...
          <div>
            <div className="mb-10">
              <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                ...
                What is GeniousGen all about?
              </h3>
              <p className="text-gray-500 dark:text-gray-400">GeniousGen is your one-stop destination for intellectual growth and fun learning! We provide a curated collection of blog posts generated by AI and engaging quizzes to enhance your knowledge and stimulate your curiosity.</p>
            </div>
            <div className="mb-10">
              <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd"></path></svg>
                How can I access the blog posts and quizzes on GeniousGen?
              </h3>
              <p className="text-gray-500 dark:text-gray-400">Accessing the wealth of knowledge on GeniousGen is simple! Just sign up for an account, and you'll gain instant access to our AI-generated blog posts covering various topics. Additionally, you can explore our interactive quizzes to test your understanding and learn in a fun way!</p>
            </div>
          </div>
          <div>
            <div className="mb-10">
              ...
              <p className="text-gray-500 dark:text-gray-400">Yes, GeniousGen is completely free to use! Simply sign up for an account and start exploring our vast collection of blog posts and quizzes at no cost. We're committed to providing accessible and valuable educational resources to all users.</p>
            </div>
            <div className="mb-10">
              <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd"></path></svg>
              ...
              <p className="text-gray-500 dark:text-gray-400">Your feedback is invaluable to us! If you have any suggestions, questions, or encounter any issues while using GeniousGen, please don't hesitate to reach out to our support team. We're here to assist you and ensure you have the best possible experience.</p>
            </div>
